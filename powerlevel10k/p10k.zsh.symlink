# Generated by Powerlevel10k configuration wizard on 2020-04-23 at 22:56 HKT.
...
() {
  ...
  # prompt.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR='' # alternative '·'
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    # The color of the filler.
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=111
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='$' # alternative '❯'
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%a %Y-%m-%d %H:%M:%S %Z}'
